  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blue-lg'>
      ...
      <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
        ...
        <img src={assets.help_icon} alt="" className='max-ms:hidden max-w-5' />
      </div>
      {/*chat area*/}
        ...
        {messagesDummyData.map((msg,index)=>(
          <div key={index} className={`flex items-end gap-2 justify-end ${msg.senderId !== '680f50e4f10f3cd28382ecf9' && 'flex-row-reverse'}`}>
            {msg.image ? (
              ...
              <p className={`p-2 max-w-[200px] ms:text-sm font-light rounded-lg mb-8 break-all bg-violet-500/30 text-white ${msg.senderId === '680f50e4f10f3cd28382ecf9' ? 'rounded-br-none' : 'rounded-bl-none'}`}>{msg.text}</p>
            )}
    ...
    bottom area 
    <div className='absolute bottom-0 left-0 right-0 flex items-center ap-3 p-3'>
